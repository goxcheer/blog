...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(title==null || title==''){
			...
			$.post("${pageContext.request.contextPath}/admin/blog/save.do",{'id':'${param.id}','title':title,'blogCategory.id':blogTypeId,
...
<div id="p" class="easyui-panel" title="修改博客" style="padding: 10px">
	<table cellspacing="20px">
		...
		<tr>
			<td>所属类别：</td>
			<td>
				<select class="easyui-combobox" style="width: 154px" id="blogCategory" name="blogCategory.id" editable="false" panelHeight="auto">
    	...
    	UE.ajax.request("${pageContext.request.contextPath}/admin/blog/getBlogById.do",
    			{
    				...
    				onsuccess:function(result){
    					...
    					$("#blogCategory").combobox("setValue",result.blogCategory.id);
