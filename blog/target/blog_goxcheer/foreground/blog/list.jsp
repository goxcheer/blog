	  		...
	  		<div class="datas">
	  			<ul>
	  				...
	  				<li style="margin-bottom: 30px">
					  	...
					  	<span class="img">
					  			<c:forEach var="image" items="${blog.imgList}">
									${image}
							&nbsp;&nbsp;
								</c:forEach>
					  	...
					  	<span class="info">发表于 <fmt:formatDate value="${blog.releaseDate }" type="date" pattern="yyyy-MM-dd HH:mm"/> 阅读(${blog.clickCount }) 评论(${blog.replyCount }) </span>
