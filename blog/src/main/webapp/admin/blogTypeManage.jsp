...
<script type="text/javascript">
	...
	function openBlogTypeAddDialog(){
		...
		url="${pageContext.request.contextPath}/admin/blogCategory/save.do";
	}
	...
	function openBlogTypeModifyDialog(){
		...
		$("#fm").form("load",row);
		url="${pageContext.request.contextPath}/admin/blogCategory/save.do?id="+row.id;
	}
	...
	function deleteBlogType(){
		...
		$.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/admin/blogCategory/delete.do",{ids:ids},function(result){
					if(result.success){
						if(result.exist){
...
<table id="dg" title="博客类别管理" class="easyui-datagrid" 
  ...
  url="${pageContext.request.contextPath}/admin/blogCategory/list.do" fit="true" toolbar="#tb">
  <thead>
  	<tr>
  		<th field="cb" checkbox="true" align="center"></th>
  		<th field="id" width="20" align="center">编号</th>
  		<th field="categoryName" width="100" align="center">博客类型名称</th>
		<th field="blogCount" width="100" align="center">该类型下的博客数量</th>
  		<th field="priority" width="100" align="center">排序序号</th>
  	</tr>
  </thead>
</table>
<div id="tb">
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			<tr>
				<td>博客类别名称：</td>
				<td>
					<input type="text" id="typeName" name="categoryName" class="easyui-validatebox" required="true"/>
				</td>
			</tr>
			<tr>
				<td>博客类别排序：</td>
				<td>
					<input type="text" id="orderNo" name="priority" class="easyui-numberbox" required="true" style="width: 60px"/>&nbsp;(类别根据排序序号从小到大排序)
				</td>
			</tr>
		</table>
	</form>
