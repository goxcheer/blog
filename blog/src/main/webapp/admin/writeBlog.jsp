...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitData() {
            var title = $("#title").val();
            var blogTypeId = $("#blogCategory").combobox("getValue")
    ...
    <script type="text/javascript">
        $(function () {
            $("#blogCategory").combobox({
                url: "${pageContext.request.contextPath}/admin/blog/listBlogCategory.do",
...
<div id="p" class="easyui-panel" title="编写博客" style="padding: 10px">
    <table cellspacing="20px">
        ...
        <tr>
            <td>所属类别：</td>
            <td>
                <select class="easyui-combobox" style="width: 154px" id="blogCategory" name="blogCategory.id"
        ...
        <tr>
            ...
            <td><script id="editor" name="content" type="text/plain" style="width:100%;height:500px;"></script></td>
        </tr>
        <tr>
            <td> 关键字：</td>
            <td><input type="text" id="keyWord" name="keyWord" style="width: 400px"/>& nbsp; (多个关键字中间用空格隔开)</td>
        </tr>
        <tr>
            <td> </td>
